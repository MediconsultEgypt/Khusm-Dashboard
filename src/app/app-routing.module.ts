...
const routes: Routes = [
  ...
  // },
  {
    ...
    children: [
      ...
      { path: 'provider', loadChildren: () => import('./modules/provider/provider.module').then(m => m.ProviderModule), canActivate: [authGuard] },
      { path: 'order', loadChildren: () => import('./modules/orders/order.module').then(m => m.OrderModule) },
      { path: 'newAdminPanel', loadChildren: () => import('./modules/new-admin-panel/new-admin-panel.module').then(m => m.NewAdminPanelModule), canActivate: [authGuard] },
      { path: 'broker', loadChildren: () => import('./modules/broker/broker.module').then(m => m.BrokerModule), canActivate: [authGuard] },
      { path: 'addon', loadChildren: () => import('./modules/Add On/AddOn.module').then(m => m.AddOnModule), canActivate: [authGuard] },
      {
        path: 'widgets',
        loadChildren: () =>
