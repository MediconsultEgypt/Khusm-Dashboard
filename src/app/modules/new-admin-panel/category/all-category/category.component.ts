...
import { category, providerResponse } from '../category.model';
...
export class CategoryComponent implements OnInit {
  ...
  categories: category[];
  selectedProviderBranches: category[] | null = [];
  cols: any[] = [];
  ...
  // *export to excel
  exportExcel() {
    const data = document.getElementById("categories");
  ...
  // get categories
  getAll(page: number) {
    this._CategoryService.get_all(page)
