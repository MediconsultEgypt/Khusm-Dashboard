...
import { Allprovider_branch, providerResponse } from '../provider-branch.model';
import * as FileSaver from 'file-saver';

@Component({
    selector: 'app-provider-branch',
    templateUrl: './provider-branch.component.html',
    styleUrls: ['./provider-branch.component.css']
})
export class ProviderBranchComponent implements OnInit {
  @ViewChild('closeModal') closeModal: ElementRef

  // Decorator
  @ViewChild(DatatableComponent) table: DatatableComponent;

  providers: Allprovider_branch[];
  selectedProviderBranches: Allprovider_branch[] | null = [];
  cols: any[] = [];
  ...
  constructor(
    ...
    injector: Injector,
    private _ProviderBranchService: ProviderBranchService
    ) {
  ...
  ngOnInit(): void {
    ...
    //   { field: this.serviceItemName, header: 'NAME' },
      ...
      { field: 'provider_branch_location', header: 'Provider branch location' },
...
saveAsExcelFile(buffer: any, fileName: string): void {
  ...
  getAll_provider_branchs(page: number) {
    this._ProviderBranchService.get_provider_branchs(page)
