...
import { total_prov_orders } from '../dashboard-datatables.model';


@Component({
  selector: 'app-total-prov-orders',
  templateUrl: './total-prov-orders.component.html',
  styleUrls: ['./total-prov-orders.component.css']
})
export class TotalProvOrdersComponent implements OnInit {
  @ViewChild('closeModal') closeModal: ElementRef

  // Decorator
  @ViewChild(DatatableComponent) table: DatatableComponent;

  total_prov_orders: total_prov_orders[];
  selectedItems: total_prov_orders[] | null = [];
  cols: any[] = [];
  ...
  exportToPdf() {
    const data = this.total_prov_orders;
  ...
  // *export to excel
  exportExcel() {
    const data = document.getElementById("total_prov_orders");
  ...
  // get total visits
  getAll() {
    this._DashboardDatatablesService.get_total_prov_orders()
      .subscribe((res) => {
        this.total_prov_orders = res;
      })
  }
